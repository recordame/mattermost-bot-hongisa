...
from common.utils import get_alarms
...
class Alarms(Plugin):
    ...
    def get_alarms(self, message: Message):
        msg = get_alarms(constant.CHANNEL_ALARMS)
        self.driver.direct_message(message.user_id, msg)

        msg = get_alarms(constant.USER_ALARMS, "ALL")
        self.driver.direct_message(message.user_id, msg)
    ...
    def get_user_alarms(self, message: Message):
        msg = get_alarms(constant.USER_ALARMS, message.user_id)
        self.driver.direct_message(message.user_id, msg)
